...
event zeek_init() &priority=0
	...
	Log::remove_filter(Weird::LOG, "default");
	Log::remove_filter(HTTP::LOG, "default");
	Log::remove_filter(SSH::LOG, "default");
	Log::remove_filter(DHCP::LOG, "default");
	Log::remove_filter(NTP::LOG, "default");
	}
...
#         [
#         $name="sqlite",
#         $path="/home/fsc/liujy/file_watch/zeek",
#         $config=table(["tablename"] = "tls"),
